...
export default function ClientSearchBar({setSearchInput,setSearch,setShowActives,searchInput,search,showActives}:ClientSearchBarProps) {
  return (
   <div className="flex flex-col lg:flex-row lg:gap-10 gap-3 items-center mb-4 lg:mb-8">
            <div className="relative w-full lg:w-xl">
              ...
              {!search && <FiSearch
                ...
                size={20}
                className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 cursor-pointer bg-white"
              />}
              {search && <FiXCircle
